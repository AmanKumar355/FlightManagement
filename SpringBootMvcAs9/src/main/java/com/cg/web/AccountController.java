...
public class AccountController {
	...
	public String processTransferFundPg(@Valid @ModelAttribute("tbean") TransferBean tbean, BindingResult br, Model model) {
		if(br.hasErrors())
			return "TransferformPage";
		try {
			...
			return "HomePage";
		} catch(com.cg.exception.AccountException ex) {
